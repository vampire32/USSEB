...
import T1 from "../styles/images/baqi.jpg"
import T2 from "../styles/images/rasool.jpg"
import T3 from "../styles/images/kawish.jpeg"
import T4 from "../styles/images/t4.jpg"
			...
			<section className="bg-white dark:bg-gray-900">
				<div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
					...
					>
						...
						<div className="text-center text-gray-500 dark:text-gray-400">
							<div className="mx-auto mb-4 w-36 h-36 rounded-full">
								<Image
									style={{
										borderRadius: "9999px",
										marginLeft: "auto",
						...
						<div className="text-center text-gray-500 dark:text-gray-400">
							...
							/>
							<h3 className="mb-1 text-1xl font-bold tracking-tight text-gray-900 ">
								<a href="#">Ghulam Mujtaba Sangi</a>
							</h3>
							<p>Architech Engineer</p>
							{/* <ul className="flex justify-center mt-4 space-x-4">
								<li>
									<a
										href="#"
