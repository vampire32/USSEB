				...
				>
					<div className="carousel-inner relative w-full overflow-hidden">
						<div className="carousel-item active relative float-left w-full">
							...
							<div className="flex flex-wrap justify-center">
								<div className="grow-0 shrink-0 basis-auto w-full lg:w-8/12 px-3">
									<h5 className="text-lg font-bold mb-3">Hassan Tariq</h5>
						...
						<div className="carousel-item relative float-left w-full">
							...
							<div className="flex flex-wrap justify-center">
								<div className="grow-0 shrink-0 basis-auto w-full lg:w-8/12 px-3">
									<h5 className="text-lg font-bold mb-3">Mujeeb Khan</h5>
									...
									<p className="text-gray-500 mb-6">
										...
										Excellent service, good quality and Very easy to access your
										shop thats very helpful for us
									</p>
									<ul className="flex justify-center mb-0">
										<li>
											<svg
						...
						<div className="carousel-item relative float-left w-full">
							...
							<div className="flex flex-wrap justify-center">
								<div className="grow-0 shrink-0 basis-auto w-full lg:w-8/12 px-3">
									<h5 className="text-lg font-bold mb-3">Shoaib Khan</h5>
									...
									<p className="text-gray-500 mb-6">
										...
										I highly recommend fairy of fortune used furniture. Items
										are just like brand new and at a reasonable prices. USS Copany
										was very polite, answered all questions asked about
										products. He gave warranty and recommended I stay in touch.
									</p>
									<ul className="flex justify-center mb-0">
										<li>
											<svg
